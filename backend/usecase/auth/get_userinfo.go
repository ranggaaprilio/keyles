...
func NewGetUserInfo(userRepo repositories.UserRepository) *GetUserInfo {
	return &GetUserInfo{
		userRepo: userRepo,
	}
}
...
func (uc *GetUserInfo) Execute(ctx context.Context, userID string) (*UserInfoClaims, error) {
	// Validate input
	if userID == "" {
