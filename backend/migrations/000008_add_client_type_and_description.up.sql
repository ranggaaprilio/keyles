...
ALTER TABLE clients ADD CONSTRAINT clients_valid_client_type CHECK (client_type IN ('confidential', 'public'));

-- Add check constraint: confidential clients MUST have a secret
ALTER TABLE clients ADD CONSTRAINT clients_secret_required_for_confidential CHECK (
    client_type = 'public'
