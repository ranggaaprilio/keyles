...
func TestAuthorizeClient_Execute(t *testing.T) {
	...
	tests := []struct {
		...
		setupMocks    func(*mocks.MockClientRepository, *mocks.MockRoleRepository, *mocks.MockAuthCodeRepository)
		wantErr       bool
		errContains   string
	...
	}{
		{
			...
			setupMocks: func(cr *mocks.MockClientRepository, rr *mocks.MockRoleRepository, ar *mocks.MockAuthCodeRepository) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.setupMocks != nil {
				tt.setupMocks(mockClientRepo, mockRoleRepo, mockAuthCodeRepo)
			}

			uc := auth.NewAuthorizeClient(mockClientRepo, mockRoleRepo, mockAuthCodeRepo)
